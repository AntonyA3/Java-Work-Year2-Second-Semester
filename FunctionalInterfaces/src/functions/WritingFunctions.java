...
public class WritingFunctions {
	...
	public static void main(String[] args) {
		...
		Function<String, Character> firstCharacter = n -> n.charAt(0);
		System.out.println("\nThe first letter of the name is " + firstCharacter.apply("Jole"));
		
		
		ToIntFunction<Integer> square = (x) -> x * x;
		System.out.println("squaring...");
		Stream.of(1,2,3,4,5).mapToInt(square).forEach(i -> System.out.println("\n " + i ));
		
		System.out.println("Halving...");
		ToDoubleFunction<Integer> half = x ->x.doubleValue()/2;
		Stream.of(1,2,3,4,5).mapToDouble(half).forEach(i -> System.out.println("\n " + i ));
	}
