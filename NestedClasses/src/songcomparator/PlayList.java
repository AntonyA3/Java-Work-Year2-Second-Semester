...
public class PlayList implements Iterable<Song> {
	...
	public void sortPlaylist() {
		Collections.sort(songlist); //or same as
	...
	public Optional<Song>  min () {
		return songlist.stream().min(Comparator.naturalOrder());
	}
	
	public Optional<Song>  min (Comparator<Song> comparator) {
		return songlist.stream().min(comparator);
	}
	
	public Optional<Song>  max () {
		return songlist.stream().max(Comparator.naturalOrder());
	}
	
	public Optional<Song>  max (Comparator<Song> comparator) {
		return songlist.stream().max(comparator);
	}
	
	public static class SongDurationReverseComparator implements Comparator<Song> {
